...
public class BookController {
    ...
    public ResponseEntity<ResponseDTO> addBook(@RequestBody @Valid BookDTO bookDTO) {
        ResponseDTO responseDTO = new ResponseDTO("Added Book to store", bookServices.addBookStock(bookDTO));
    ...
    public ResponseEntity<ResponseDTO> getBooks() {
        ResponseDTO responseDTO = new ResponseDTO("View all the Books in store", bookServices.getBooks());
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> getBookById(@PathVariable int bookId) throws BookNotFoundException {
        ResponseDTO responseDTO = new ResponseDTO("View book with id: " + bookId, bookServices.getBookByBookId(bookId));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> updateBookById(@PathVariable int bookId, @RequestBody @Valid BookDTO bookDTO) throws BookNotFoundException {
        ResponseDTO responseDTO = new ResponseDTO("Updated book with id: " + bookDTO, bookServices.updateBookById(bookId,bookDTO));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
